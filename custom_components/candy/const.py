...
UNIQUE_ID_TUMBLE_REMAINING_MINUTES = "{0}-tumble_remaining_minutes"
UNIQUE_ID_TUMBLE_DRY_LEVEL = "{0}-tumble_dry_level"
UNIQUE_ID_TUMBLE_DRY_LEVEL_NOW = "{0}-tumble_dry_level_now"
UNIQUE_ID_TUMBLE_REMOTE_CONTROL = "{0}-tumble_remote_control"
UNIQUE_ID_TUMBLE_REFRESH = "{0}-tumble_refresh"
UNIQUE_ID_TUMBLE_NEED_CLEAN_FILTER = "{0}-tumble_need_clean_filter"
UNIQUE_ID_TUMBLE_WATER_TANK_FULL = "{0}-tumble_water_tank_full"
UNIQUE_ID_TUMBLE_DOOR_CLOSED = "{0}-tumble_door_closed"
